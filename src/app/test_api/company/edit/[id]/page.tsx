...
export default function edit() {
    ...
    async function addFavForm(formData: FormData) {
        ...
        const rawFormData = {
            id_seeker: formData.get("id_seeker"),
            url_cv: user!.cv,
        };
                ...
                <div>
                    ...
                    <form action={addFavForm} className="space-y-4">
                        ...
                        <div>
                            <span>ID Sekeer</span>
                            <br />
                            <input type="text" name="id_seeker" id="id_seeker" className="border broder-2 ml-2" value={user!._id} required />
                        </div>
