      ...
      <div className="font-sans">
        ...
        >
          <div className="relative sm:max-w-sm w-full">
            <div className="card bg-cyan-700 shadow-lg w-full h-full rounded-3xl absolute transform -rotate-6" />
            <div className="card bg-violet-800 shadow-lg w-full h-full rounded-3xl absolute transform rotate-6" />
